...
import com.StudentAnalysis.Graphs.HeatMap;
import com.StudentAnalysis.Graphs.NGClusters;
import com.StudentAnalysis.Graphs.PolygonGraph;
import com.StudentAnalysis.Graphs.StackBarHistogram;
import com.StudentAnalysis.Launcher;
import com.StudentAnalysis.Utils.CheckBoxPopup;
...
public class DataSet {
    ...
    private static final String[] LAL_COUNT_LABELS = {
        "59", "60", "61", "62", "63", "64", "65", "66", "67", "68", "69", "70", "71", "72", "73",
        "74", "75", "76", "77", "78", "79", "80", "81", "82", "83", "84", "85", "86", "87", "88",
        "89", "90", "91", "92", "93", "94", "95", "96", "97", "98", "99", "100"
    }; // Example labels for Lal Count
    ...
    public DataSet(Pane root, Stage stage) {
        ...
        // change to index 4 when the predicate checkbox is selected and keep the current filtered
        // data set
        ...
        predicate.setOnAction(
                event -> {
                    ...
                    int[] surunaStates =
                            CheckBoxPopup.getCheckboxStates(CheckBoxPopup.surunaCheckboxes);
                    int[] hurniStates =
                            CheckBoxPopup.getCheckboxStates(CheckBoxPopup.hurniCheckboxes);
                    int[] lalCountStates =
                            CheckBoxPopup.getCheckboxStates(CheckBoxPopup.lalCountCheckboxes);
                    int[] voltaStates =
                            CheckBoxPopup.getCheckboxStates(CheckBoxPopup.voltaCheckboxes);
    ...
    public void setData(int index) {
        // initialize the table dataSets depending on the index value and the predicate checkBox
        // state
        ...
        // calculate the average grades of the data set depending on the index, and the predicate
        // checkBox state
        // also calculates the difference from the global average of the global average, of the
        // other data set.
        double sum = 0;
        double differences1;
        if (index == 3) {
            ...
            WidgetSetup.updateLabelsAndIconsDataset(
                    sum, 30, grades.length - 1, differences1, index); // update the side panel
        } else if (index == 4) {
        ...
        Image heatMapIcon =
                new Image(
                        Objects.requireNonNull(
                                getClass()
                                        .getResourceAsStream(
                                                "/com/StudentAnalysis/images/HeatMap.png")));
        ...
        Image stackBarHistogramIcon =
                new Image(
                        Objects.requireNonNull(
                                getClass()
                                        .getResourceAsStream(
                                                "/com/StudentAnalysis/images/stackBarHistogramIcon.png")));
        ...
        Image scatterImage =
                new Image(
                        Objects.requireNonNull(
                                getClass()
                                        .getResourceAsStream(
                                                "/com/StudentAnalysis/images/ScatterIcon.png")));
        ...
        Image checkBoxImage =
                new Image(
                        Objects.requireNonNull(
                                getClass()
                                        .getResourceAsStream(
                                                "/com/StudentAnalysis/images/CheckBoxIcon.png")));
    ...
    public static void filterTable(
            ObservableList<String[]> data, int[] one, int[] two, int[] three, int[] four) {
        ...
        // reload the datalist from the original data list at the start to re-add the row when
        // checking again a checkbox
        ...
        checkBoxMappings.forEach(
                (checkboxes, labelColumnPair) -> {
    ...
    public void draw(int index) {
        ...
        // add the table, the switch button, the heatMap and the stackBarHistogram to the root if it
