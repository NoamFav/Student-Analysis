...
import com.StudentAnalysis.AI.Predict;
import com.StudentAnalysis.Graphs.Graph;
import com.StudentAnalysis.Launcher;
import com.StudentAnalysis.Utils.CheckBoxPopup;
import com.StudentAnalysis.Utils.PdfSaver;
...
public class Menu {
    ...
    public void createScene(Stage stage, Pane root) {
        ...
        Image Logo =
                new Image(
                        Objects.requireNonNull(
                                getClass()
                                        .getResourceAsStream(
                                                "/com/StudentAnalysis/images/cropped.png")));
        Image DataSetIcon =
                new Image(
                        Objects.requireNonNull(
                                getClass()
                                        .getResourceAsStream(
                                                "/com/StudentAnalysis/images/dataset.png")));
        Image StudentsIcon =
                new Image(
                        Objects.requireNonNull(
                                getClass()
                                        .getResourceAsStream(
                                                "/com/StudentAnalysis/images/student.png")));
        Image CoursesIcon =
                new Image(
                        Objects.requireNonNull(
                                getClass()
                                        .getResourceAsStream(
                                                "/com/StudentAnalysis/images/courses.png")));
        Image GraphicsIcon =
                new Image(
                        Objects.requireNonNull(
                                getClass()
                                        .getResourceAsStream(
                                                "/com/StudentAnalysis/images/graph.png")));
        Image LeaveIcon =
                new Image(
                        Objects.requireNonNull(
                                getClass()
                                        .getResourceAsStream(
                                                "/com/StudentAnalysis/images/Leave.png")));
        Image HelpIcon =
                new Image(
                        Objects.requireNonNull(
                                getClass()
                                        .getResourceAsStream(
                                                "/com/StudentAnalysis/images/help.png")));
        ...
        new SearchBar(
                root,
                Launcher.Distance(1920, 1066, root.getWidth()),
                Launcher.Distance(1080, 76, root.getHeight()),
                stage);
        new PdfSaver(
                root,
                Launcher.Distance(1920, 1527, root.getWidth()),
                Launcher.Distance(1080, 76, root.getHeight()));
        new WidgetSetup(root);
        new Predict(root, stage);

        // for each, check every instance of the pages created over the entire application, delete
        // them if they exist, and draw the one needed
        DataSetButton.setOnAction(
                e -> {
