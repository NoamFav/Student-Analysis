...
import com.StudentAnalysis.MainPage.DataSet;
...
public class CheckBoxPopup {
    ...
    public static final CheckBox[] lalCountCheckboxes = {
        fiftynine,
        sixty,
        sixtyone,
        sixtytwo,
    ...
    public static final CheckBox[] allCheckboxes = {
        doot,
        lobi,
        nulp,
        full,
    ...
    private static final javafx.beans.value.ChangeListener<Boolean> individualCheckboxListener =
            (observable, oldValue, newValue) -> {
                // check if all checkboxes are selected and set the all CheckBox to false if they
                // aren't
                if (!newValue) {
    ...
    public HBox CreateCheckBox() {
        ...
        // make so that when all the checkboxes are selected, make the all checkbox selected and if
        // not, make the all checkbox unselected
        for (CheckBox cb : allCheckboxes) {
    ...
    public void createPopUP(Stage stage, Pane root) {
        ...
        // Create the HBox containing all the CheckBoxes grouped and position it based on the popup
        // width and height
    ...
    public void onPopupClose(WindowEvent event) {
        DataSet.filterTable(
                DataSet.dataList,
                getCheckboxStates(surunaCheckboxes),
                getCheckboxStates(hurniCheckboxes),
                getCheckboxStates(lalCountCheckboxes),
                getCheckboxStates(voltaCheckboxes));
    }
