...
public class graduateCourseCard {
    ...
    private final double[] averages =
            new double[rowCount - 1]; // An array to store the average grades that each student gets
    ...
    public String[][] courseInfo(String id) {
        ...
        for (int i = 1; i < colCount; i++) {
            ...
            if (data[0][i].equals(id)) {
                ...
                infoArray[0][1] =
                        data[0][i] + " Grade"; // store course names and the student's corresponding
                // grade of the course
                ...
                for (int j = 1; j < rowCount; j++) {
                    ...
                    infoArray[j][1] =
                            data[j][i]; // place actual grades on the 1st column of infoArray
                    infoArray[j][2] =
                            Double.toString(
                                    averageArray[j - 1]); // place student average grades on the
                    // 2nd column of infoArray
                }
