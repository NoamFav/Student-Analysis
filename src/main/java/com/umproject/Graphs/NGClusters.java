...
public class NGClusters {
    ...
    private void CreateClusters(String[][] gradeArray, Pane root, double dimensionX, double dimensionY) {
        ...
        Map<String, Integer> sortedMap = courseNGMap.entrySet().stream()
            ...
            data.nodeProperty().addListener((obs, oldNode, newNode) -> {
                if (newNode != null) {
                    ...
                    newNode.setOnMouseEntered(event -> {
                        newNode.setScaleX(2);
                        newNode.setScaleY(2);
                        newNode.setStyle("-fx-background-color: rgba(173, 216, 230, 0.8)");
                    });
