...
public class BoxPlot{
    ...
    public void createIndividualBox(Pane root, double[] grades, double dimensionX, double dimensionY, String courseName, Pane mainPane) {
        ...
        Platform.runLater(() -> {
            ...
            Rectangle box = new Rectangle(root.getWidth()/2- Launcher.Distance(1920,250, mainPane.getWidth()), yForQ3, Launcher.Distance(1920,500, mainPane.getWidth()), boxHeight);
            ...
            Line medianLine = new Line(root.getWidth()/2- Launcher.Distance(1920,250, mainPane.getWidth()), yForMedian, root.getWidth()/2+ Launcher.Distance(1920,250, mainPane.getWidth()), yForMedian);
            ...
            for (Double outlierValue : outlierValues) {
                ...
                Circle outlierCircle = new Circle(xPosition, yForOutlier, 3, javafx.scene.paint.Color.ORANGE);
    ...
    public void showGraphInPopup(Stage stage, String[] data, Pane root, int index, String courseName) {
        //Create Popup
        ...
        if (index == 0) {
            ...
            createIndividualBox(graphPane, StringToDouble(data), graphPaneWidth, graphPaneHeight, courseName, root);
        }
