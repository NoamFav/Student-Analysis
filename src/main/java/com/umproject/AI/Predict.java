...
public class Predict {
    ...
    private void predictGrades(Stage stage, Pane root) throws IOException {
        ...
        button.setOnAction(event -> {
            ...
            if (courseInput.isEmpty() || Id.getText().isEmpty() || !SearchBar.studentIds.contains(Id.getText()) || !SearchBar.courses.contains(courseInput)) {
        ...
        vbox.setPrefWidth(popupPane.getPrefWidth() - Launcher.Distance(1920, 100, root.getWidth() ));  // Adjust width as needed
        vbox.setPrefHeight(popupPane.getPrefHeight() - Launcher.Distance(1080, 100, root.getHeight())); // Adjust height as needed
