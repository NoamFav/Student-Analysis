...
import com.umproject.Cards.graduateStudentCard;
import com.umproject.Cards.studentCard;
        ...
        if (index == 0) {
            ...
            for (String[] datum : data) {
                if (datum[0].equals(input)) {
                    ...
                    attributesLabel.setText("Suruna Value: " + datum[1] + ", Hurni Level: " + datum[2] + "\nLal Count: " + datum[3] + ", Volta: " + datum[4] + ", Ratio: " + roundedString);
                }
            }
        } else {
